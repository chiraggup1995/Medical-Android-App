...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public void addUser(String name,String email,String uid, String created_at)
    {
        ...
        contentValues.put(KEY_NAME,name);//NAME
        contentValues.put(KEY_EMAIL,email);//EMAIL
        contentValues.put(KEY_UID,uid);//UID
        contentValues.put(KEY_CREATED_AT,created_at);//CREATED AT
    ...
    public HashMap<String,String> getUserDetails()
    {
        ...
        if(cursor.getCount()>0)
        {
            ...
            user.put("created_id",cursor.getString(4));
        }
        cursor.close();
        db.close();
        //return user
